-- ============================================================================
-- COMPLETE FIX: Clean up ALL remaining test data
-- ============================================================================
-- Purpose: Delete everything in the correct order to avoid foreign key errors
-- This fixes the partial cleanup state
-- ============================================================================

SELECT '===== STARTING COMPLETE CLEANUP =====' as section;
...
-- Delete ALL appointments (this was partially left behind)
DO $$
DECLARE deleted_count INTEGER;
BEGIN
...
-- ============================================================================
-- STEP 3: Delete patient data (now safe since appointments are gone)
-- ============================================================================

SELECT '===== Step 3: Deleting patient data =====' as section;
...
BEGIN
    ...
    -- Delete patient profiles (now safe since appointments are gone)
...
-- ============================================================================
-- STEP 4: Delete inactive clinicians
-- ============================================================================
...
SELECT '===== COMPLETE FIX DONE =====' as section;
