// Script to create test user with username and password for Razorpay verification
...
async function createTestUser() {
  ...
  try {
    console.log('\n🔐 Creating test user with username/password...\n');
    ...
    if (existingUser.rows.length > 0) {
      ...
      console.log(`DELETE FROM users WHERE username = '${username}';`);
      return;
    }
